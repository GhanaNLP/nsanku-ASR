"""Evaluation recipe for Google/speech-recognition — Nzema (nzi).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Nzema is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Nzema — set one to enable
