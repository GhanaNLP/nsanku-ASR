"""Evaluation recipe for Google/speech-recognition — Nkonya (nko).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Nkonya is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Nkonya — set one to enable
