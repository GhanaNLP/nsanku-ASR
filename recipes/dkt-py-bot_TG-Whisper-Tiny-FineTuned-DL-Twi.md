---
model: dkt-py-bot/TG-Whisper-Tiny-FineTuned-DL-Twi
language: null
task: transcribe
initial_prompt: null
---

# dkt-py-bot/TG-Whisper-Tiny-FineTuned-DL-Twi

| Field | Value |
|---|---|
| **Model** | `dkt-py-bot/TG-Whisper-Tiny-FineTuned-DL-Twi` |
| **Owner** | dkt-py-bot |
| **URL** | https://huggingface.co/dkt-py-bot/TG-Whisper-Tiny-FineTuned-DL-Twi |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | twi |
| **Status** | passed - best avg WER 201.42% (avg WER+CER 185.28%) |
