"""Evaluation recipe for Google/speech-recognition — Buli (bwu).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Buli is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Buli — set one to enable
