"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Sehwi (sfw).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Sehwi is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Sehwi belongs here (e.g. mapping a character
