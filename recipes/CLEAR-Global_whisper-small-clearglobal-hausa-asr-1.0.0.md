# CLEAR-Global/whisper-small-clearglobal-hausa-asr-1.0.0

| Field | Value |
|---|---|
| **Model** | `CLEAR-Global/whisper-small-clearglobal-hausa-asr-1.0.0` |
| **Owner** | CLEAR-Global |
| **URL** | https://huggingface.co/CLEAR-Global/whisper-small-clearglobal-hausa-asr-1.0.0 |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | hau |
| **Status** | passed - best avg WER 77.28% |
