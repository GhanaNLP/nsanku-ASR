"""Evaluation recipe for Google/speech-recognition — Ntrubo (ntr).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ntrubo is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Ntrubo — set one to enable
