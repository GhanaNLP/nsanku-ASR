"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Dagaare (dga).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Dagaare is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Dagaare belongs here (e.g. mapping a character
