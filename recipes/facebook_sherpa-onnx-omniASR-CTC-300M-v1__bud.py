"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Bassar_Ntcham (bud).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Bassar_Ntcham is evaluated.
"""
