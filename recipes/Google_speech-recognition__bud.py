"""Evaluation recipe for Google/speech-recognition — Bassar_Ntcham (bud).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Bassar_Ntcham is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Bassar_Ntcham — set one to enable
