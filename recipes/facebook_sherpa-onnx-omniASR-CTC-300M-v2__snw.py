"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Selee (snw).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Selee is evaluated.
"""
