"""Evaluation recipe for Google/speech-recognition — Gonja (gjn).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Gonja is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Gonja — set one to enable
