"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Paasaal (sig).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Paasaal is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Paasaal belongs here (e.g. mapping a character
