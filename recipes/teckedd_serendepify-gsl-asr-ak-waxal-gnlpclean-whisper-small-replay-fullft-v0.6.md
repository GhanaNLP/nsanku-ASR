---
model: teckedd/serendepify-gsl-asr-ak-waxal-gnlpclean-whisper-small-replay-fullft-v0.6
language: null
task: transcribe
initial_prompt: null
---
...
| **Model** | `teckedd/serendepify-gsl-asr-ak-waxal-gnlpclean-whisper-small-replay-fullft-v0.6` |
| **Owner** | teckedd |
| **URL** | https://huggingface.co/teckedd/serendepify-gsl-asr-ak-waxal-gnlpclean-whisper-small-replay-fullft-v0.6 |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | twi |
| **Status** | passed - best avg WER 94.58% (avg WER+CER 78.48%) |
