---
model: waxal-benchmarking/mms-300m-waxal-ewe
ctc_decoder: greedy
---

# waxal-benchmarking/mms-300m-waxal-ewe

| Field | Value |
|---|---|
| **Model** | `waxal-benchmarking/mms-300m-waxal-ewe` |
| **Owner** | waxal-benchmarking |
| **URL** | https://huggingface.co/waxal-benchmarking/mms-300m-waxal-ewe |
...
| **Status** | passed - best avg WER 61.86% (avg WER+CER 39.52%) |
