"""Evaluation recipe for Google/speech-recognition — Birifor_Southern (biv).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Birifor_Southern is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Birifor_Southern — set one to enable
