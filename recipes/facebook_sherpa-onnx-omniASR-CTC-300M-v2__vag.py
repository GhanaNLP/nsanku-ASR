"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Vagla (vag).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Vagla is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Vagla belongs here (e.g. mapping a character
