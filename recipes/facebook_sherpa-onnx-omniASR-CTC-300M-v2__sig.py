"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Paasaal (sig).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Paasaal is evaluated.
"""
