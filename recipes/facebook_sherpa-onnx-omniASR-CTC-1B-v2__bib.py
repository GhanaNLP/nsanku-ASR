"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Bissa (bib).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Bissa is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Bissa belongs here (e.g. mapping a character
