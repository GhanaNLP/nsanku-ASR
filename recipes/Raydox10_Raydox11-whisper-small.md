---
model: Raydox10/Raydox11-whisper-small
language: null
task: transcribe
initial_prompt: null
---

# Raydox10/Raydox11-whisper-small

| Field | Value |
|---|---|
| **Model** | `Raydox10/Raydox11-whisper-small` |
| **Owner** | Raydox10 |
| **URL** | https://huggingface.co/Raydox10/Raydox11-whisper-small |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | twi |
| **Status** | passed - best avg WER 102.84% (avg WER+CER 79.48%) |
