"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Akuapem Twi (twi_akuapem).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Akuapem Twi is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Akuapem Twi belongs here (e.g. mapping a character
