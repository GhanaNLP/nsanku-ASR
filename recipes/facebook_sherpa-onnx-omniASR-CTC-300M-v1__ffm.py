"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Fulfulde_Maasina (ffm).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Fulfulde_Maasina is evaluated.
"""
