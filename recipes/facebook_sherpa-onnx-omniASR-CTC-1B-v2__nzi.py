"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Nzema (nzi).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Nzema is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Nzema belongs here (e.g. mapping a character
