"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Deg (mzw).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Deg is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Deg belongs here (e.g. mapping a character
