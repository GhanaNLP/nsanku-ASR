"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Avatime (avn).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Avatime is evaluated.
"""
