"""Evaluation recipe for Google/speech-recognition — Bimoba (bim).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Bimoba is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Bimoba — set one to enable
