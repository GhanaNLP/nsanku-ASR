"""Evaluation recipe for KhayaAI/khaya-asr-v3 — Tampulma (tpm).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Tampulma is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Khaya has no code for Tampulma yet — set one to enable
