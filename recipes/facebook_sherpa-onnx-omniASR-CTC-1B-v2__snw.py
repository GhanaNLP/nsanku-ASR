"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Selee (snw).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Selee is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Selee belongs here (e.g. mapping a character
