"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Mampruli (maw).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Mampruli is evaluated.
"""
