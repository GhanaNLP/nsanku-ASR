"""Evaluation recipe for Google/speech-recognition — Selee (snw).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Selee is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Selee — set one to enable
