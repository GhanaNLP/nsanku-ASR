"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Nkonya (nko).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Nkonya is evaluated.
"""
