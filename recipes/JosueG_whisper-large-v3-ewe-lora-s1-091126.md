---
model: JosueG/whisper-large-v3-ewe-lora-s1-091126
language: null
task: transcribe
initial_prompt: null
---

# JosueG/whisper-large-v3-ewe-lora-s1-091126

| Field | Value |
|---|---|
| **Model** | `JosueG/whisper-large-v3-ewe-lora-s1-091126` |
| **Owner** | JosueG |
| **URL** | https://huggingface.co/JosueG/whisper-large-v3-ewe-lora-s1-091126 |
