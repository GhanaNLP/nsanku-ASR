"""Evaluation recipe for Google/speech-recognition — Dagbani (dag).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Dagbani is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Dagbani — set one to enable
