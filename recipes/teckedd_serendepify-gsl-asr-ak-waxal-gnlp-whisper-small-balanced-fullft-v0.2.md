---
model: teckedd/serendepify-gsl-asr-ak-waxal-gnlp-whisper-small-balanced-fullft-v0.2
language: null
task: transcribe
initial_prompt: null
---
...
| **Model** | `teckedd/serendepify-gsl-asr-ak-waxal-gnlp-whisper-small-balanced-fullft-v0.2` |
| **Owner** | teckedd |
| **URL** | https://huggingface.co/teckedd/serendepify-gsl-asr-ak-waxal-gnlp-whisper-small-balanced-fullft-v0.2 |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | twi |
| **Status** | passed - best avg WER 101.97% (avg WER+CER 85.24%) |
