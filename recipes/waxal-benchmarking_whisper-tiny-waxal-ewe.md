---
model: waxal-benchmarking/whisper-tiny-waxal-ewe
language: null
task: transcribe
initial_prompt: null
---

# waxal-benchmarking/whisper-tiny-waxal-ewe

| Field | Value |
|---|---|
| **Model** | `waxal-benchmarking/whisper-tiny-waxal-ewe` |
| **Owner** | waxal-benchmarking |
| **URL** | https://huggingface.co/waxal-benchmarking/whisper-tiny-waxal-ewe |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | ewe |
| **Status** | passed - best avg WER 96.99% (avg WER+CER 70.82%) |
