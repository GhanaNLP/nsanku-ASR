---
model: alphaedge-ai/whisper-large-v3-turbo-hau-32768
language: null
task: transcribe
initial_prompt: null
---

# alphaedge-ai/whisper-large-v3-turbo-hau-32768

| Field | Value |
|---|---|
| **Model** | `alphaedge-ai/whisper-large-v3-turbo-hau-32768` |
| **Owner** | alphaedge-ai |
| **URL** | https://huggingface.co/alphaedge-ai/whisper-large-v3-turbo-hau-32768 |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | hau |
| **Status** | passed - best avg WER 131.85% (avg WER+CER 113.66%) |
