---
model: teckedd/serendepify-gsl-asr-ak-waxal-whisper-small-only-lowlr-freezeenc-fullft-v0.4
language: null
task: transcribe
initial_prompt: null
---
...
| **Model** | `teckedd/serendepify-gsl-asr-ak-waxal-whisper-small-only-lowlr-freezeenc-fullft-v0.4` |
| **Owner** | teckedd |
| **URL** | https://huggingface.co/teckedd/serendepify-gsl-asr-ak-waxal-whisper-small-only-lowlr-freezeenc-fullft-v0.4 |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | twi |
| **Status** | passed - best avg WER 90.46% (avg WER+CER 76.02%) |
