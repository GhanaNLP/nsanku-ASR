"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Ninkare (gur).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ninkare is evaluated.
"""
