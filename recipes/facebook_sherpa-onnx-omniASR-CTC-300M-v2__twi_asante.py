"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Asante Twi (twi_asante).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Asante Twi is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Asante Twi belongs here (e.g. mapping a character
