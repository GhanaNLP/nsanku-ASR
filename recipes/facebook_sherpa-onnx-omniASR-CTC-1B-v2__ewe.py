"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Ewe (ewe).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Ewe is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Ewe belongs here (e.g. mapping a character
