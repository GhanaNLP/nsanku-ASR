"""Evaluation recipe for Google/speech-recognition — Ninkare (gur).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ninkare is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Ninkare — set one to enable
