---
model: cdli/whisper-small_finetuned_ghanian_ga_nonstandard_speech_v1.0
language: null
task: transcribe
initial_prompt: null
---
...
| **Model** | `cdli/whisper-small_finetuned_ghanian_ga_nonstandard_speech_v1.0` |
| **Owner** | cdli |
| **URL** | https://huggingface.co/cdli/whisper-small_finetuned_ghanian_ga_nonstandard_speech_v1.0 |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | gaa |
| **Status** | passed - best avg WER 96.74% (avg WER+CER 72.11%) |
