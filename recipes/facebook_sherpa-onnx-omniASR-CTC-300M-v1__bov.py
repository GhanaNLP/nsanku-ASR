"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Tuwuli (bov).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Tuwuli is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Tuwuli belongs here (e.g. mapping a character
