"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Avatime (avn).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Avatime is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Avatime belongs here (e.g. mapping a character
