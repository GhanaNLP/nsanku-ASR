"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Fante (fat).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Fante is evaluated.
"""
