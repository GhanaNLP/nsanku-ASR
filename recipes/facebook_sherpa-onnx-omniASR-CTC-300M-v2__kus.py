"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Kusaal (kus).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Kusaal is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Kusaal belongs here (e.g. mapping a character
