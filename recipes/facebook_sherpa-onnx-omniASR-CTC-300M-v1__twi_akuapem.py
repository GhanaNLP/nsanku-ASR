"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Akuapem Twi (twi_akuapem).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Akuapem Twi is evaluated.
"""
