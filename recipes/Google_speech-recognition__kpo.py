"""Evaluation recipe for Google/speech-recognition — Ikposo (kpo).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ikposo is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Ikposo — set one to enable
