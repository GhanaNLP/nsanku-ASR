---
model: waxal-benchmarking/whisper-tiny-waxal-dag
language: null
task: transcribe
initial_prompt: null
---

# waxal-benchmarking/whisper-tiny-waxal-dag

| Field | Value |
|---|---|
| **Model** | `waxal-benchmarking/whisper-tiny-waxal-dag` |
| **Owner** | waxal-benchmarking |
| **URL** | https://huggingface.co/waxal-benchmarking/whisper-tiny-waxal-dag |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | dag |
| **Status** | passed - best avg WER 86.27% (avg WER+CER 68.16%) |
