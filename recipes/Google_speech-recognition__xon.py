"""Evaluation recipe for Google/speech-recognition — Konkomba (xon).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Konkomba is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Konkomba — set one to enable
