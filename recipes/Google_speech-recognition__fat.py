"""Evaluation recipe for Google/speech-recognition — Fante (fat).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Fante is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Fante — set one to enable
