"""Evaluation recipe for Google/speech-recognition — Dangme (ada).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Dangme is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Dangme — set one to enable
