---
model: waxal-benchmarking/mms-300m-waxal-dag
ctc_decoder: greedy
---

# waxal-benchmarking/mms-300m-waxal-dag

| Field | Value |
|---|---|
| **Model** | `waxal-benchmarking/mms-300m-waxal-dag` |
| **Owner** | waxal-benchmarking |
| **URL** | https://huggingface.co/waxal-benchmarking/mms-300m-waxal-dag |
...
| **Status** | passed - best avg WER 68.71% (avg WER+CER 47.31%) |
