"""Evaluation recipe for Google/speech-recognition — Avatime (avn).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Avatime is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Avatime — set one to enable
