"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Chumburung (ncu).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Chumburung is evaluated.
"""
