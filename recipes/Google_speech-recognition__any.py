"""Evaluation recipe for Google/speech-recognition — Anyin (any).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Anyin is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Anyin — set one to enable
