"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Ikposo (kpo).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ikposo is evaluated.
"""
