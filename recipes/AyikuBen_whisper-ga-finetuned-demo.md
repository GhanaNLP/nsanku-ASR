---
model: AyikuBen/whisper-ga-finetuned-demo
language: null
task: transcribe
initial_prompt: null
---

# AyikuBen/whisper-ga-finetuned-demo

| Field | Value |
|---|---|
| **Model** | `AyikuBen/whisper-ga-finetuned-demo` |
| **Owner** | AyikuBen |
| **URL** | https://huggingface.co/AyikuBen/whisper-ga-finetuned-demo |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | gaa |
| **Status** | passed - best avg WER 132.42% (avg WER+CER 98.12%) |
