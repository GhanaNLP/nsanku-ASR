"""Evaluation recipe for Google/speech-recognition — Gikyode (acd).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Gikyode is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Gikyode — set one to enable
