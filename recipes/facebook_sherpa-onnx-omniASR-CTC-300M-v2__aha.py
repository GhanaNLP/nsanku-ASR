"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Ahanta (aha).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ahanta is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Ahanta belongs here (e.g. mapping a character
