"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Konkomba (xon).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Konkomba is evaluated.
"""
