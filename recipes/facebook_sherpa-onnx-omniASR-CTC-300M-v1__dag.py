"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Dagbani (dag).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Dagbani is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Dagbani belongs here (e.g. mapping a character
