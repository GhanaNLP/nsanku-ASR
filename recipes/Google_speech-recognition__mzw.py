"""Evaluation recipe for Google/speech-recognition — Deg (mzw).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Deg is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Deg — set one to enable
