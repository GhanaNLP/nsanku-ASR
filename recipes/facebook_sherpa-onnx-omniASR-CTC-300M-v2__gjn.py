"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Gonja (gjn).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Gonja is evaluated.
"""
