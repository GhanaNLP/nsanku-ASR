"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Sehwi (sfw).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Sehwi is evaluated.
"""
