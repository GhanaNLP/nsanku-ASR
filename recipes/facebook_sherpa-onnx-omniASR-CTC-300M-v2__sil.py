"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Sisaala_Tumulung (sil).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Sisaala_Tumulung is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Sisaala_Tumulung belongs here (e.g. mapping a character
