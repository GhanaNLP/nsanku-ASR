"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Ikposo (kpo).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Ikposo is evaluated.
"""


LANGUAGE_NAME = 'Ikposo'
...
def postprocess(text):
    ...
    orthography normalisation for Ikposo belongs here (e.g. mapping a character
