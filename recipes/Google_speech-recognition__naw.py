"""Evaluation recipe for Google/speech-recognition — Nawuri (naw).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Nawuri is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Nawuri — set one to enable
