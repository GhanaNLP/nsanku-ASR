"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Siwu (akp).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Siwu is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Siwu belongs here (e.g. mapping a character
