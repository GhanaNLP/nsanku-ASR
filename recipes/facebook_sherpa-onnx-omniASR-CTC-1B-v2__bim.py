"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Bimoba (bim).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Bimoba is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Bimoba belongs here (e.g. mapping a character
