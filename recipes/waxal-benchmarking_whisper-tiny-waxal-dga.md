---
model: waxal-benchmarking/whisper-tiny-waxal-dga
language: null
task: transcribe
initial_prompt: null
---

# waxal-benchmarking/whisper-tiny-waxal-dga

| Field | Value |
|---|---|
| **Model** | `waxal-benchmarking/whisper-tiny-waxal-dga` |
| **Owner** | waxal-benchmarking |
| **URL** | https://huggingface.co/waxal-benchmarking/whisper-tiny-waxal-dga |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | dga |
| **Status** | passed - best avg WER 73.79% (avg WER+CER 57.06%) |
