"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Dangme (ada).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Dangme is evaluated.
"""


LANGUAGE_NAME = 'Dangme'
...
def postprocess(text):
    ...
    orthography normalisation for Dangme belongs here (e.g. mapping a character
