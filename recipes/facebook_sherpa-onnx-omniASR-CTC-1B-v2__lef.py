"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Lelemi (lef).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Lelemi is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Lelemi belongs here (e.g. mapping a character
