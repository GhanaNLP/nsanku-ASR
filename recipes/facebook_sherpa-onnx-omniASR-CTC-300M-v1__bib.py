"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Bissa (bib).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Bissa is evaluated.
"""
