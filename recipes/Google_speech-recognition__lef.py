"""Evaluation recipe for Google/speech-recognition — Lelemi (lef).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Lelemi is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Lelemi — set one to enable
