"""Evaluation recipe for Google/speech-recognition — Hausa (hau).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Hausa is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Hausa — set one to enable
