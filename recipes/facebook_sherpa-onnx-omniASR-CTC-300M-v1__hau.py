"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Hausa (hau).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Hausa is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Hausa belongs here (e.g. mapping a character
