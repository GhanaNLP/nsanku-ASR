"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Chumburung (ncu).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Chumburung is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Chumburung belongs here (e.g. mapping a character
