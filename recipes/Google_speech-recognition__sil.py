"""Evaluation recipe for Google/speech-recognition — Sisaala_Tumulung (sil).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Sisaala_Tumulung is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Sisaala_Tumulung — set one to enable
