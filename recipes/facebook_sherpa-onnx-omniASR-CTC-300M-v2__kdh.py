"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Tem (kdh).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Tem is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Tem belongs here (e.g. mapping a character
