"""Evaluation recipe for Google/speech-recognition — Dagaare (dga).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Dagaare is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Dagaare — set one to enable
