"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Birifor_Southern (biv).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Birifor_Southern is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Birifor_Southern belongs here (e.g. mapping a character
