"""Evaluation recipe for Google/speech-recognition — Chumburung (ncu).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Chumburung is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Chumburung — set one to enable
