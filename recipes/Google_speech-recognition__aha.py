"""Evaluation recipe for Google/speech-recognition — Ahanta (aha).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ahanta is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Ahanta — set one to enable
