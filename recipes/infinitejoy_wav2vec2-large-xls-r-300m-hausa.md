---
model: infinitejoy/wav2vec2-large-xls-r-300m-hausa
ctc_decoder: greedy
---
...
| **Model** | `infinitejoy/wav2vec2-large-xls-r-300m-hausa` |
| **Owner** | infinitejoy |
| **URL** | https://huggingface.co/infinitejoy/wav2vec2-large-xls-r-300m-hausa |
...
| **Status** | passed - best avg WER 110.42% (avg WER+CER 198.61%) |
