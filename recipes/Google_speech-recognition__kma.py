"""Evaluation recipe for Google/speech-recognition — Konni (kma).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Konni is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Konni — set one to enable
