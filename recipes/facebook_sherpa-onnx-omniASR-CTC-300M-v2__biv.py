"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Birifor_Southern (biv).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Birifor_Southern is evaluated.
"""
