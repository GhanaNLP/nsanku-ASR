"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Buli (bwu).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Buli is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Buli belongs here (e.g. mapping a character
