"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Nkonya (nko).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Nkonya is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Nkonya belongs here (e.g. mapping a character
