"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Ntrubo (ntr).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ntrubo is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Ntrubo belongs here (e.g. mapping a character
