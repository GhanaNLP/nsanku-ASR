---
model: waxal-benchmarking/whisper-small-waxal-ewe
language: null
task: transcribe
initial_prompt: null
---

# waxal-benchmarking/whisper-small-waxal-ewe

| Field | Value |
|---|---|
| **Model** | `waxal-benchmarking/whisper-small-waxal-ewe` |
| **Owner** | waxal-benchmarking |
| **URL** | https://huggingface.co/waxal-benchmarking/whisper-small-waxal-ewe |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | ewe |
| **Status** | passed - best avg WER 73.08% (avg WER+CER 49.78%) |
