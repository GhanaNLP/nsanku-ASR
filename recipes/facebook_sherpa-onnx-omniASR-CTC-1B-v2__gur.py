"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Ninkare (gur).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Ninkare is evaluated.
"""


LANGUAGE_NAME = 'Ninkare'
...
def postprocess(text):
    ...
    orthography normalisation for Ninkare belongs here (e.g. mapping a character
