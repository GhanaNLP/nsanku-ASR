"""Evaluation recipe for Google/speech-recognition — Bissa (bib).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Bissa is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Bissa — set one to enable
