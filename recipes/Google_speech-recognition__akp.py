"""Evaluation recipe for Google/speech-recognition — Siwu (akp).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Siwu is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Siwu — set one to enable
