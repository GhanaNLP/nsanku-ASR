"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Kasem (xsm).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Kasem is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Kasem belongs here (e.g. mapping a character
