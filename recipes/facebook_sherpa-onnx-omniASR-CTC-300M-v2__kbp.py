"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Kabiye (kbp).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Kabiye is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Kabiye belongs here (e.g. mapping a character
