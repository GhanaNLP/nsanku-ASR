"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Ga (gaa).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Ga is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Ga belongs here (e.g. mapping a character
