"""Evaluation recipe for Google/speech-recognition — Vagla (vag).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Vagla is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Vagla — set one to enable
