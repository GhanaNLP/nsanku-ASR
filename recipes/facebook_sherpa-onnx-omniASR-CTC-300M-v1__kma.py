"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Konni (kma).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Konni is evaluated.
"""
