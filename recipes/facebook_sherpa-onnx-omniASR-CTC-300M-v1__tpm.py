"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Tampulma (tpm).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Tampulma is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Tampulma belongs here (e.g. mapping a character
