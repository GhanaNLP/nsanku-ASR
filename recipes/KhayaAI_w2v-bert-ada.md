---
model: KhayaAI/w2v-bert-ada
ctc_decoder: greedy
---

# KhayaAI/w2v-bert-ada

| Field | Value |
|---|---|
| **Model** | `KhayaAI/w2v-bert-ada` |
| **Owner** | KhayaAI |
| **URL** | https://huggingface.co/KhayaAI/w2v-bert-ada |
| **Architecture** | CTC (AutoModelForCTC) |
| **Precision** | fp32 (wav2vec2/xls-r/MMS conv encoders crash in bf16 on Hopper) |
| **Benchmarked languages** | ada |
| **Status** | passed - best avg WER 17.69% (avg WER+CER 13.41%) |
