"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Fante (fat).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Fante is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Fante belongs here (e.g. mapping a character
