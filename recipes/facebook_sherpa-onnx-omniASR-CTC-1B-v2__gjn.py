"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Gonja (gjn).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Gonja is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Gonja belongs here (e.g. mapping a character
