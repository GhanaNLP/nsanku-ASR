"""Evaluation recipe for Google/speech-recognition — Tem (kdh).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Tem is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Tem — set one to enable
