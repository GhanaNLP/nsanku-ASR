---
model: KhayaAI/w2v-bert-nzi
ctc_decoder: greedy
---

# KhayaAI/w2v-bert-nzi

| Field | Value |
|---|---|
| **Model** | `KhayaAI/w2v-bert-nzi` |
| **Owner** | KhayaAI |
| **URL** | https://huggingface.co/KhayaAI/w2v-bert-nzi |
| **Architecture** | CTC (AutoModelForCTC) |
| **Precision** | fp32 (wav2vec2/xls-r/MMS conv encoders crash in bf16 on Hopper) |
| **Benchmarked languages** | nzi |
| **Status** | passed - best avg WER 55.89% (avg WER+CER 44.90%) |
