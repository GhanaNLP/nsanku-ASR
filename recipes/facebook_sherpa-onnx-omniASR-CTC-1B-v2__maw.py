"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Mampruli (maw).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Mampruli is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Mampruli belongs here (e.g. mapping a character
