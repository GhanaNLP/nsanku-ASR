"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Konni (kma).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Konni is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Konni belongs here (e.g. mapping a character
