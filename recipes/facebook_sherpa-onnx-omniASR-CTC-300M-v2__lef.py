"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Lelemi (lef).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Lelemi is evaluated.
"""
