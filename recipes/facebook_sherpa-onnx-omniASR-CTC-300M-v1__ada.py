"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Dangme (ada).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Dangme is evaluated.
"""
