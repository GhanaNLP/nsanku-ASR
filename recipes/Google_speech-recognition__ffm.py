"""Evaluation recipe for Google/speech-recognition — Fulfulde_Maasina (ffm).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Fulfulde_Maasina is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Fulfulde_Maasina — set one to enable
