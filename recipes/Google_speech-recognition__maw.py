"""Evaluation recipe for Google/speech-recognition — Mampruli (maw).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Mampruli is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Mampruli — set one to enable
