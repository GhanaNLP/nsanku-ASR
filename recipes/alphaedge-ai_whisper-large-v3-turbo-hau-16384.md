---
model: alphaedge-ai/whisper-large-v3-turbo-hau-16384
language: null
task: transcribe
initial_prompt: null
---

# alphaedge-ai/whisper-large-v3-turbo-hau-16384

| Field | Value |
|---|---|
| **Model** | `alphaedge-ai/whisper-large-v3-turbo-hau-16384` |
| **Owner** | alphaedge-ai |
| **URL** | https://huggingface.co/alphaedge-ai/whisper-large-v3-turbo-hau-16384 |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | hau |
| **Status** | passed - best avg WER 120.58% (avg WER+CER 103.39%) |
