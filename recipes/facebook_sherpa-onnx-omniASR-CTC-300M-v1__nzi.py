"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Nzema (nzi).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Nzema is evaluated.
"""
