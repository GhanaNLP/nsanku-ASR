"""Evaluation recipe for Google/speech-recognition — Kasem (xsm).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Kasem is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Kasem — set one to enable
