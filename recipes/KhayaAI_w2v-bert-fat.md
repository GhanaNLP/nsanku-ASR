---
model: KhayaAI/w2v-bert-fat
ctc_decoder: greedy
---

# KhayaAI/w2v-bert-fat

| Field | Value |
|---|---|
| **Model** | `KhayaAI/w2v-bert-fat` |
| **Owner** | KhayaAI |
| **URL** | https://huggingface.co/KhayaAI/w2v-bert-fat |
| **Architecture** | CTC (AutoModelForCTC) |
| **Precision** | fp32 (wav2vec2/xls-r/MMS conv encoders crash in bf16 on Hopper) |
| **Benchmarked languages** | fat |
| **Status** | passed - best avg WER 79.16% (avg WER+CER 57.46%) |
