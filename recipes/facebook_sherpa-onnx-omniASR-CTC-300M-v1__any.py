"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v1 — Anyin (any).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Anyin is evaluated.
"""
...
def postprocess(text):
    ...
    orthography normalisation for Anyin belongs here (e.g. mapping a character
