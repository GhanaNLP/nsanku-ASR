"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Bassar_Ntcham (bud).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Bassar_Ntcham is evaluated.
"""


LANGUAGE_NAME = 'Bassar_Ntcham'
...
def postprocess(text):
    ...
    orthography normalisation for Bassar_Ntcham belongs here (e.g. mapping a character
