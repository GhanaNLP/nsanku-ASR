"""Evaluation recipe for Google/speech-recognition — Sekpele (lip).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Sekpele is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Sekpele — set one to enable
