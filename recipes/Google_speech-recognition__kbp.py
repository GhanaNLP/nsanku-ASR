"""Evaluation recipe for Google/speech-recognition — Kabiye (kbp).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Kabiye is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Kabiye — set one to enable
