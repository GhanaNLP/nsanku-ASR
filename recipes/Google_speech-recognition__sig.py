"""Evaluation recipe for Google/speech-recognition — Paasaal (sig).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Paasaal is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Paasaal — set one to enable
