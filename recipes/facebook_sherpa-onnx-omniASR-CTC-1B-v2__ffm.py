"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-1B-v2 — Fulfulde_Maasina (ffm).
...
https://github.com/GhanaNLP/nsanku-ASR to change how Fulfulde_Maasina is evaluated.
"""


LANGUAGE_NAME = 'Fulfulde_Maasina'
...
def postprocess(text):
    ...
    orthography normalisation for Fulfulde_Maasina belongs here (e.g. mapping a character
