"""Evaluation recipe for facebook/sherpa-onnx-omniASR-CTC-300M-v2 — Bimoba (bim).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Bimoba is evaluated.
"""
