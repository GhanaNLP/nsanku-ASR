"""Evaluation recipe for Google/speech-recognition — Sehwi (sfw).
...
https://github.com/GhanaNLP/nsanku-asr-benchmark to change how Sehwi is evaluated on the
next benchmark run.
"""


LANGUAGE_CODE = None  # Google has no code for Sehwi — set one to enable
