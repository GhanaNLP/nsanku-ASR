---
model: waxal-benchmarking/whisper-small-waxal-dag
language: null
task: transcribe
initial_prompt: null
---
...
| **URL** | https://huggingface.co/waxal-benchmarking/whisper-small-waxal-dag |
| **Architecture** | Whisper seq2seq (AutoModelForSpeechSeq2Seq) |
| **Precision** | bf16 |
| **Benchmarked languages** | dag |
| **Status** | passed - best avg WER 74.97% (avg WER+CER 55.83%) |
